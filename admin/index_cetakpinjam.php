...
<body>
    <div style="padding: 15px;">
        <h3 style="margin-top: 0;"><b>Laporan Peminjaman Buku</b></h3>
        <hr />

        <form method="get" action="index_cetakpinjam.php">
            <div class="row">
            ...
            if (isset($_GET['filter'])) // Jika user mengisi filter tanggal, maka munculkan tombol untuk reset filter
                echo '<a href="index_cetakpinjam.php" class="btn btn-default">RESET</a>';
            ?>
        </form>
        ...
        if (empty($tgl_awal) or empty($tgl_akhir)) { // Cek jika tgl_awal atau tgl_akhir kosong, maka :
            ...
            $url_cetak = "printpinjam.php?tgl_awal=" . $tgl_awal . "&tgl_akhir=" . $tgl_akhir . "&filter=true";
