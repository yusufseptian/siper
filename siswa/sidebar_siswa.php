        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="data_buku.php">Daftar Buku</a>
                        <a class="collapse-item" href="data_bukutamusiswa.php">Buku Tamu</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="history_peminjaman.php">History Transaksi</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <?php
                                $nis = $_SESSION['nis'];
                                $query = "select * from tbl_peminjaman inner join tbl_buku on tbl_peminjaman.id_buku = tbl_buku.id_buku where keterangan = 'Belum Kembali' and nis='$nis'";
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                                ...
                                <?php while ($data = mysqli_fetch_assoc($dtPeminjaman)) : ?>
                                    ...
                                    <?php if ($dateDiff > 7) : ?>
                                        <a class="dropdown-item d-flex align-items-center" href="history_peminjaman.php">
                                            <div class="mr-3">
                                            ...
                                            <div>
                                                ...
                                                <span class="font-weight-bold">
                                                    Buku <?= ucfirst($data['judul_buku']) ?> telah telat dikembalikan selama
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Halo, Saya <?php echo $_SESSION['nama_siswa']; ?></span>
                                <img src="../assets/img/logout.png" width="30">
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="kartuanggota.php">
